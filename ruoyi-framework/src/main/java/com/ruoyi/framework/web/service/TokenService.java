...
public class TokenService {
    ...
    public String createToken(LoginUser loginUser) {
        ...
        String jwtTokenRedisKey = CacheConstants.LOGIN_JWT_TOKEN + loginUser.getUsername();
        redisCache.setCacheObject(jwtTokenRedisKey, jwtToken, expireTime, TimeUnit.MINUTES);
        return jwtToken;
    }
