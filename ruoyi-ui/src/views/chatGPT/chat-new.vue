      ...
      >
        ...
        >
          ...
          >
            ...
            <el-card class="control-card" :style="'overflow-y: auto;' + (isShowSetting? '' : 'padding-left:0px')">
              <!--              <el-tabs
                              v-model="activeName"
                              class="tabs"
                            >
    ...
    >
      ...
      <el-collapse v-model="activeTutorial" accordion>
        <el-collapse-item v-for="(item, index) in tutorialList" :name="(index+1)+''">
          <template slot="title">
            <span style="font-size: 18px;">{{ (index + 1) + '. ' + item.title }}</span>
          </template>
          ...
          <div class="tutorial-flex" :style="isMobile ? 'flex-direction: column;' : ''">
            ...
            <div class="tutorial-right" align="center" :style="isMobile ? 'width:100%;' : ''">
              ...
              <div class="tutorial-demo-describe" style="color: #2D9CDB;border-color: #2D9CDB;">设置内容：{{ item.after.setting }}</div>
              <!-- 用户 -->
              <div
                style="padding:12px;"
                align="right"
