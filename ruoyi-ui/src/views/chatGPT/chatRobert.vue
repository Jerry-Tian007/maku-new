  ...
  <div class="back">
    ...
    <div class="backgrond">
      <div
        ...
        :style="isMobile ? 'background:#00000000;width:100%;height:50px;display: flex;align-items: center;justify-content: end' : 'height:0px;'"
      >
      ...
      <div
        ...
        style=""
      >
        <div :style="isMobile ? 'flex:0.02;' : 'width:0px;display:flex;flex-direction: column;'" align="center">
        </div>
        <!--flex布局-聊天-->
          ...
          >
            ...
            <div class="clear-button-hide" style="width:80%;display: flex;align-items: center;"
              ...
              <div style="width: 100%;text-align: center">
                <span v-if="isShowSetting" style="font-size: 18px;">隐藏</span>
              </div>
            </div>
            <el-card v-if="false" class="control-card" :style="'overflow-y: auto;' + (isShowSetting? '' : 'padding-left:0px')">
              <el-form
  ...
  data() {
    return {
      ...
      tutorialList: [
        ...
        {
          title: '模型选择',
          text: '在模型选择中，您可以选择需要使用的GPT模型。目前支持GPT-3.5与GPT-4。需注意：使用的模型不同，Token单价以及最终产生的费用也会不同。',
          before: {
        ...
        {
          title: '发散性',
          text: '在发散性中，您可以设定范围为0~2的对话发散性，GPT会在对话时根据设定值控制回复对问题的关联性。须知：靠近2为较高的值，可使回答更随机发散；靠近0为较低的值，可使问题更集中贴近问题。',
          before: {
            setting: '0.2',
            question: '如何学习编程',
            answer: '学习编程可以遵循以下步骤：\n' +
      ...
      chatQuestion(url, data) //post请求，传递参数text
        .then(response => { //请求成功
          ...
          if (response.code === 200) {
            ...
            console.log(422)
            let words = '\n问题词汇：' + response.detail[0].contexts.map(item => {return item.context}).join(';');
