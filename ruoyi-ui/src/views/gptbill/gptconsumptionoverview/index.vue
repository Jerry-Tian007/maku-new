    ...
    <div class="backgrond">
      <div class="chat-background">
        <div class="content-card">
          ...
          >
            <div style="flex:4;font-size:20px;color:#507BB6;">
              <span style="font-size: 18px;color:#87A5CF">部门名称：
              </span>{{ data.deptName }}
            </div>
            <div
          ...
          <div style="flex:1;display:flex;">
            ...
            <div
              style="flex:1;width:100%;display:flex;flex-direction: column;align-items: center;padding-left:10px;"
            >
              <div
                style="flex:1;width: 100%;"
                ref="history"
              >
                <div style="padding:10px 0;font-size: 18px;">历史账单</div>
                <el-table
                  :data="billList"
                  :height="historyTableHeight-48"
                  :row-style="{height:'60px',backgroundColor:'#ffffff80'}"
                >
                  <el-table-column
                    label="序号"
  ...
  methods: {
    ...
    getHistory () {
      ...
      listBill({
        ...
        this.historyTableHeight = this.$refs['history'].clientHeight;
        this.loading = false;
      });
    },
