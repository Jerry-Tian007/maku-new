 ...
 */
@RestController
@RequestMapping("/kb/user-model-parameter")
public class KbUserModelParameterController extends BaseController {

    @Resource
    private IKbUserModelParameterService iKbUserModelParameterService;
    ...
    public R<Integer> add(@RequestBody @Validated UserModelParameterAddDto userModelParameterAddDto) {
        return R.success(iKbUserModelParameterService.add(userModelParameterAddDto));
    }
    ...
    public R<Integer> update(@RequestBody @Validated UserModelParameterUpdateDto userModelParameterUpdateDto) {
        return R.success(iKbUserModelParameterService.update(userModelParameterUpdateDto));
    }
    ...
    public R<Integer> delete(@PathVariable("id") Long id) {
        return R.success(iKbUserModelParameterService.delete(id));
    }
    ...
    public PageDataInfo<UserModelParameterPageVO> pageList(@RequestBody UserModelParameterPageQryDto userModelParameterPageQryDto) {
        startPage();
        return getPageData(iKbUserModelParameterService.pageList(userModelParameterPageQryDto));
    }
    ...
    public R<UserModelParameterInfoVO> getById(@PathVariable("id") Long id) {
        return R.success(iKbUserModelParameterService.getById(id));
    }
    ...
    public R<UserModelParameterPageVO> getParameter(@RequestBody @Validated UserModelParameterGetDto userModelParameterGetDto) {
        return R.success(iKbUserModelParameterService.getParameter(userModelParameterGetDto));
    }
